...
const womens = {
    render() {
      ...
      <div class="flex flex-row justify-between my-5">
        <h2 class="text-3xl">Woment's Collection</h2>
   ...
   ${womentsData.map((wo) =>
    ...
    <a href="#">
      <img src="${wo.product_img}" class="rounded-tl-lg rounded-tr-lg" />
    </a>
    <div class="p-5">
      <h3><a href="#">${wo.product_titile}</a></h3>
      <span>${wo.product_price}</span>
      ...
      <div class="flex flex-col xl:flex-row justify-between">
        ...
        <a class="bg-purple-600 rounded-full py-2 px-4 my-2 text-sm text-white hover:bg-purple-700 flex flex-row justify-center" href="/details/${wo.id}">
