...
const detailsproductPageMen = {
    render(id) {
        const result = mensData.find((men) => men.id === id);
        return /* html */`
        <div class="bg-white">
        <div class="pt-6">
          ...
          <div class="max-w-2xl mx-auto pt-10 pb-16 px-4 sm:px-6 lg:max-w-7xl lg:pt-16 lg:pb-24 lg:px-8 lg:grid lg:grid-cols-3 lg:grid-rows-[auto,auto,1fr] lg:gap-x-8">
            ...
            <div class="mt-4 lg:mt-0 lg:row-span-3">
              ...
              <p class="text-3xl text-gray-900">${result.product_price}</p>
...
export default detailsproductPageMen;